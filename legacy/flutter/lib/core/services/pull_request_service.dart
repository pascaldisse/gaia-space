...
class PullRequestService {
  ...
  Future<List<GitDiff>> getDiff(String pullRequestId) async {
    try {
              ...
              GitDiffHunk(
                ...
                lines: [
                  ...
                  GitDiffLine(
                    ...
                    content: 'This is a demo repository',
                    oldLineNum: 1,
                    newLineNum: 2,
                  ),
                  GitDiffLine(
                    type: GitDiffLineType.deletion,
                    content: 'Old line removed',
                    oldLineNum: 2,
                    newLineNum: -1,
                  ),
                  GitDiffLine(
      ...
      return [
        GitDiff(
          oldFile: 'src/main.dart',
          newFile: 'src/main.dart',
          file: 'src/main.dart',
          status: 'modified',
          hunks: [
            GitDiffHunk(
              ...
              lines: [
                ...
                GitDiffLine(
                  type: GitDiffLineType.addition,
                  content: '  _MyAppState createState() => _MyAppState();',
                  oldLineNum: -1,
                  newLineNum: 18,
                ),
                GitDiffLine(
