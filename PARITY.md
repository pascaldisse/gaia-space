...
TOTALS (8/8 audited, 356 rows): done 62 · partial 179 · stub 4 · missing 111. Matrix NOT green — steering loop active.
...
33 rows — done 10 · partial 17 · stub 0 · missing 6.
Worst gaps: swimlane grouping dimensions · matrix reports · external tracker integration. · V78: authored issue comments + durable issue activity timeline, API and Issue Detail UI wired.
