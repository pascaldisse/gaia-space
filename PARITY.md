...
TOTALS (8/8 audited, 356 rows): done 45 · partial 167 · stub 4 · missing 140. Matrix NOT green — steering loop active.
...
54 rows — done 6 · partial 24 · stub 2 · missing 22.
...
42 rows — done 1 · partial 26 · stub 0 · missing 15.
Progress (feat/w5-ide-discovery): V45 local `ide_connections` + `ide_opened_repositories`; session listing/report IPC + web dispatch/API + Applications repository chooser ⇒ “Local IDE connections/opened-repository state” partial→done. Test: `applications::tests::ide_session_reads_opened_repositories`.
