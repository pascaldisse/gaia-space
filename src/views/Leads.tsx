...
export default function Leads() {
  ...
  return <section class="leads-view">
    {/* MERGE ADAPTATION ONLY: `WorkspaceHeader` (the old dark shell's icon lozenge)
        no longer exists on this branch. Swapped for the redesign's PageHeader so the
        merge compiles; the full design-language pass follows in its own commit. */}
    <PageHeader title="Leads" subline="Landing-page contact submissions · administrator-only" actions={<button class="ghost" type="button" onClick={() => void refetch()} disabled={leads.loading}>Refresh</button>} />
