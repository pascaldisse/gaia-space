...
const VIEWS = ["Dashboard", "To-Do", "Projects", "Project Steering", "Project Settings", "Project Tasks", "Calendar", "Code Reviews", "Issues", "Chat", "Documents", "Meetings", "Members", "Users"];
