...
const personalViews:View[]=[homeView,{name:"Dashboard",icon:"home",component:Dashboard},{name:"To-Do",icon:"check",component:Todo,aliases:["todo","tasks"]},{name:"Task Ledger",icon:"check",component:LedgerTodo,slug:"task-ledger"},{name:"Absences",icon:"clock-nav",component:Absences}];
