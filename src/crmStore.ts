...
export type Account = { id: string; name: string; website: string; locationCount: number; employees: string; decisionMaker?: string; software: string; source: string; owner: string; locations: Location[] };
