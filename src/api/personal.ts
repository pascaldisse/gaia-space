...
export type Todo = { id:string; profile_id:string; content:string; due_date:string|null; project_id:string|null; done:boolean; source_entity_type:string|null; source_entity_id:string|null; assignee_ids:string[] };
export type CalendarItem = { id:string; kind:"meeting"|"task"|"deadline"; title:string; starts_at:number; ends_at:number|null; project_id:string|null; date:string|null };
