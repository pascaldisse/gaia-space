...
export const personalApi = {
  ...
  gotoSearch:(query:string,limit=30)=>call<GotoResult[]>("goto_search",{query,limit}), fullTextSearch:(query:string,limit=30)=>call<FullTextResult[]>("full_text_search",{query,limit}), dashboard:(profile_id:string)=>call<Dashboard>("dashboard_aggregate",{profileId:profile_id}),
};
