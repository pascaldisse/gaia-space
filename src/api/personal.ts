...
export type CalendarItem = { id:string; source_id:string; kind:"meeting"|"task"|"deadline"; title:string; starts_at:number; ends_at:number|null; project_id:string|null; date:string|null };
