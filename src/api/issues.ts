...
export type IssueDetail = { issue:Issue; tags:PlanningTag[]; checklists:Checklist[]; time_total_minutes:number; children:Issue[]; attachments:IssueAttachment[]; comments:IssueComment[]; activities:IssueActivity[] };
