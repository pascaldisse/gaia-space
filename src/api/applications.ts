...
export const appHttpApi={me:"/api/app/me",projects:"/api/app/projects",parameters:"/api/app/parameters"} as const;
...
installMarketplaceApp:(value:AppInstall)=>call<AppInstall>("install_marketplace_app",{value}), appInstalls:()=>call<AppInstall[]>("list_app_installs"), uninstallApp:(id:string)=>call<void>("uninstall_app",{id}),
 ...
 applications:()=>call<Application[]>("list_applications"), parameters:(application_id:string)=>call<AppParameter[]>("list_app_parameters",{applicationId:application_id}), saveParameter:(value:AppParameter)=>call<AppParameter>("save_app_parameter",{value}), deleteParameter:(application_id:string,key:string)=>call<void>("delete_app_parameter",{applicationId:application_id,key}), eventTypes:()=>call<string[]>("list_event_types"), saveApplication:(value:Application)=>call<Application>("save_application",{value}), deleteApplication:(id:string)=>call<void>("delete_application",{id}),
